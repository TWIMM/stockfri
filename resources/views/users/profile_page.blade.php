                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="tel" value="{{ old('phone', $user->tel) }}"
                                                class="form-control" required />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
        ...
        $(document).ready(function() {
                    ...
                    function loadCities(countryId) {
                        if (countryId) {
                            ...
                            $('#city').html('<option value="">Chargement des villes...</option>');
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (response.success) {
                                        ...
                                        var options = '<option value="">Sélectionnez une ville</option>';
                                        ...
                                        // If user already has a city, select it
                                        @if ($user->city)
                                            $('#city').val("{{ $user->city }}");
                                        @endif
                                    } else {
                                        $('#city').html('<option value="">Aucune ville disponible</option>');
                                    }
                                },
                                error: function() {
                                    $('#city').html('<option value="">Erreur lors du chargement des villes</option>');
                                }
                            });
                        } else {
                            $('#city').html("<option value=''>Sélectionnez avant tout un pays < /option>");
                            }
                        }

                        // Initialize cities if a country is already selected
    ...
    <script type="text/javascript">
        ...
        document.getElementById('removeImage1').addEventListener('click', function() {
            ...
            document.getElementById('ImgPreview').src =
                '{{ asset('assets/img/profiles/avatar-02.jpg') }}'; // Reset the preview image to default
        });
    </script>
