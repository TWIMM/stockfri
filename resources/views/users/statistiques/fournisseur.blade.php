    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="/statistiques_fournisseur" class="mb-4">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <a href="/statistiques_fournisseur" class="btn btn-secondary">Réinitialiser</a>
                            </div>
                        </div>
                    </form>
                            ...
                            <tbody>
                                @forelse($fournisseurs as $fournisseur)
                                    <tr>
                                        ...
                                        <td>{{ $commandeTotalPerFournisseur($fournisseur->id , 'quantity') }}</td>
                                        <td>{{ $commandeTotalPerFournisseur($fournisseur->id , 'price') }}</td>
                                        <td>
