...
@section('content')
    ...
    @include('Modals.add_team_member')
    @include('Modals.edit_team_member')
    @include('Modals.linkmembertoteam')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('team_member.listes') }}" class="mb-4">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <a href="{{ route('team_member.listes') }}" class="btn btn-secondary">Réinitialiser</a>
                            </div>
                        </div>
                    </form>
