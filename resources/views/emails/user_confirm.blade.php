    ...
    <body>
        <div class="email-container">
            ...
            <div class="email-body">
                ...
                <p>Nous sommes heureux de vous accueillir sur notre plateforme ! Vous pouvez compléter la configuration de votre compte en cliquant sur le lien ci-dessous :</p>
