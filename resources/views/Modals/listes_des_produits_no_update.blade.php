            ...
            <form action="{{ route('stock.stock_fri_order_stock') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="clientSelect" name="client_id" required readonly disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="paymentMode" name="payment_mode" required readonly disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="invoiceStatus" name="invoice_status" required readonly disabled>
                    ...
                    <div id="alreadyPayIInput" class="mb-3 d-none">
                        ...
                        <input type="number" name="already_paid" class="form-control" readonly>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="mobileReference"
                                        name="mobile_reference" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="creditCardDetails" class="payment-details d-none mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="cardType" name="card_type" readonly disabled>
        ...
        productRow.innerHTML = `
            <div class="d-flex">
                ...
                <div class="flex-fill ms-2">
                    ...
                    <input type="number" class="form-control" id="quantity${currentIndex}" name="products[${currentIndex}][quantity]" min="1" required readonly>
                </div>

                <!-- Remise -->
                <div class="flex-fill ms-2">
                    <label for="discount${currentIndex}" class="form-label">Remise (%)</label>
                    <input type="number" class="form-control" id="discount${currentIndex}" name="products[${currentIndex}][discount]" min="0" max="100" readonly>
                </div>
                ...
                <!-- Supprimer Produit -->
                <div class="flex-fill ms-2">
                    <button type="button" class="btn btn-danger removeProduct" aria-label="Supprimer produit" disabled>
                        <i class="ti ti-trash"></i>
                    </button>
                </div>
            </div>
