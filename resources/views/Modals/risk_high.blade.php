...
<div class="modal fade" id="riskConfirmationModal" tabindex="-1" aria-labelledby="riskConfirmationModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{route('commandes.trustClient')}}" method="POST">
            <input type="hidden" name="client_id" id="client_id_risk_high" value=''>
            @csrf
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mt-3">
                        <tr class="mt-3">
                            ...
                            <td>
                                <select class="form-select" name="trusted">
                        ...
                        <tr  class="mt-3">
                            ...
                            <td><input type="number" class="form-control" name="new_credit_limit"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="confirmRiskApproval" class="btn btn-danger">
