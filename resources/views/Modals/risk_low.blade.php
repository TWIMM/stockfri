        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mt-3">
                    <label for="credit_offer_amount" class="form-label">Montant disponible sans dépôt initial:</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="confirmCreditOffer" class="btn btn-success">
