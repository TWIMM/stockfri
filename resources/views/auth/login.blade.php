        ...
        <div class="account-content">
            <div class="d-flex flex-wrap w-100 vh-100 overflow-hidden account-bg-01">
                <div class="d-flex align-items-center justify-content-center flex-wrap vh-100 overflow-auto p-4 w-50 bg-backdrop">
                    ...
                    <form method="POST" action="{{ route('login.submit') }}" class="flex-fill">
                        @csrf
                        <div class="mx-auto mw-450">
                            ...
                            <div class="mb-4">
                                <h4 class="mb-2 fs-20">Connexion</h4>
                                <p>Accedez a votrre panel d'administration</p>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <h6>Nouveau sur la plateforme?<a href="{{ route('register') }}" class="text-purple link-hover"> Creer un compte</a></h6>
                            </div>
