...
<head>
    ...
    <title>verify_2fa - StockFri</title>
        ...
        <div class="account-content">
            <div class="d-flex flex-wrap w-100 vh-100 overflow-hidden account-bg-04">
                <div class="d-flex align-items-center justify-content-center flex-wrap vh-100 overflow-auto p-4 w-50 bg-backdrop">
                    <form method="get" class="digit-group login-form-control" data-group-name="digits" data-autosubmit="false" autocomplete="off" action="https://crms.dreamstechnologies.com/html/template/index.html">
                        <div class="mx-auto mw-450">
                            <div class="text-center mb-4">
                                <img src="assets/img/logo.svg" class="img-fluid" alt="Logo">
                            </div>
                            <div class="mb-4">
                                <h4 class="mb-2 fs-20">Verification 2fa</h4>
                                <p>Veuilez entrer le code qui fut envoye par mail</p>
                            </div>
                            ...
                            <div class="text-center mb-3">
                                <p class="badge badge-soft-purple shadow-none">Le code OTP expire dans 05 : 00</p>
                            </div>
                            <div class="mb-3">
                                <button type="submit" class="btn btn-primary w-100">Verifier mon compte</button>
                            </div>
