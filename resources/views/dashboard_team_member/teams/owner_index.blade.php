    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('owner.teams.listes') }}" class="mb-4">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <a href="{{ route('owner.teams.listes') }}" class="btn btn-secondary">Réinitialiser</a>
                            </div>
                        </div>
                    </form>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" data-id="{{ $team->id }}" class="btn btn-primary"
                                                id="edit-team-btn" data-bs-toggle="modal"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editButtons.forEach(function(button) {
                button.addEventListener('click', function() {
                    const teamId = button.getAttribute('data-id'); // Get the ID from the clicked button
